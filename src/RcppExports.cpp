...
RcppExport SEXP _opImputation_findMatchingSeedsCpp(SEXP candidatesSEXP, SEXP targetStateSEXP, SEXP verboseSEXP, SEXP progressEverySEXP) {
BEGIN_RCPP
...
RcppExport SEXP _opImputation_findMatchingSeedsBatchCpp(SEXP candidatesSEXP, SEXP targetStateSEXP, SEXP batchSizeSEXP, SEXP verboseSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< IntegerVector >::type candidates(candidatesSEXP);
...
static const R_CallMethodDef CallEntries[] = {
    {"_opImputation_findMatchingSeedsCpp", (DL_FUNC) &_opImputation_findMatchingSeedsCpp, 4},
    {"_opImputation_findMatchingSeedsBatchCpp", (DL_FUNC) &_opImputation_findMatchingSeedsBatchCpp, 4},
    {NULL, NULL, 0}
};

RcppExport void R_init_opImputation(DllInfo *dll) {
